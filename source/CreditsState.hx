...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
            ...
            ['FullCombro',		'combro',		'Mania Mode Charts',						'https://twitter.com/FullCombruh',	'cac280'],
            ['Starbreak',		'starbreak',		'Menu Theme',						'https://twitter.com/StarbreakM',	'0d2678'],
            ['Spacedust',		'spacedust',		'Background Artist',						'',	'a0a0a0'],
            ['Mangoci',		'mangoci',		'GF Voice Actress',						'https://twitter.com/FinjaKiehn',	'e2d996'],
